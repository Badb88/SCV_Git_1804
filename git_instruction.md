...
```
git clone https://github.com/AndreyBulgakov19/SCV_Git_1804.git
```
...
```
При выполнение этой команды в Форке проекта на сайте GitHub вы увидите созданную дополнительную ветку и предложение отправить владельцу архива свои изменения и доработки? кнопку **`Compare & Pull request`** с каким то коментарием к нашему предложениею.

![image](compare_pull.png)